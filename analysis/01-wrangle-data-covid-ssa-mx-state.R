...
#ssa <- fread("data-raw/210206COVID19MEXICO.csv",header=TRUE)
...
df_covid_ssa_state$time_stamp <- Sys.Date() - 1
...
write.csv(df_covid_ssa_state, paste0("data/state/covid_ssa_state_",Sys.Date() - 1,".csv"),
         row.names = FALSE)
# # #
