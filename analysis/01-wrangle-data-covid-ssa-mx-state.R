...
#ssa <- fread("data-raw/210124COVID19MEXICO.csv",header=TRUE)
...
#df_covid_ssa_state$time_stamp <- "2021-01-24"
...
write.csv(df_covid_ssa_state, paste0("data/state/covid_ssa_state_",Sys.Date(),".csv"),
         row.names = FALSE)
# # # # 
# write.csv(df_covid_ssa_state, "data/state/covid_ssa_state_2021-01-24.csv",
#               row.names = FALSE)
