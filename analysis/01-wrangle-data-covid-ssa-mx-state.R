...
####            Load data                 #### 
#--------------------------------------------#
ssa <- fread("data-raw/200808COVID19MEXICO.csv",header=TRUE)
...
df_covid_ssa_state$time_stamp <- "2020-08-08"
...
write.csv(df_covid_ssa_state, "data/state/covid_ssa_state_2020-08-08.csv",
       row.names = FALSE)
